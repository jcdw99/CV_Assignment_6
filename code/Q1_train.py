...
if __name__ == '__main__':
    ...
    for e in range(0, EPOCHS):
        ...
        # loop over the training set, seems like this is a batch!
        ...
        trainCorrect = trainCorrect / len(trainDataLoader.dataset)  # type: ignore
        valCorrect = valCorrect / len(valDataLoader.dataset) # type: ignore

        # update our training history
        H["train_loss"].append(avgTrainLoss.cpu().detach().numpy()) # type: ignore
        H["train_acc"].append(trainCorrect)
        H["val_loss"].append(avgValLoss.cpu().detach().numpy()) # type: ignore
